...
public class SaveService {
    ...
    // Default file name
    private static final String SAVESERVICE_PROPERTIES_FILE = SaveService.class.getResource("/").getPath().replace("%20", " ")+"saveservice.properties"; // $NON-NLS-1$
    ...
    public static Properties loadProperties() throws IOException{
        ...
        try {
            fis = new FileInputStream(new File(SAVESERVICE_PROPERTIES_FILE));
            nameMap.load(fis);
        } finally {
